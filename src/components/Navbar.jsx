...
const Navbar = () => {
    return(
        ...
        <Col className="nav-col d-flex justify-content-center align-items-center" xs={10}>
            <div className="input-search">
                ...
                <ul className="ul-nav">
                    ...
                    <li >
                        ...
                        <span className="d-none d-lg-block">Tu <IoMdArrowDropdown className="freccia-dropdown"/></span>
                    </li>
                    </ul>
                    <ul className="ul-nav">
                        <li>
                            < CgMenuGridR className="i-nav"/>
                            <span className="d-none d-lg-block">Lavoro <IoMdArrowDropdown className="freccia-dropdown"/></span>
                        </li>
                        <li >
